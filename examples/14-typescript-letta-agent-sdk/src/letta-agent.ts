...
export async function resolveOrCreateAgent(
  ...
  return client.createAgent({
    ...
    persona:
      "You are a concise assistant exposed through an A2A server. Preserve useful context across turns and answer only with information appropriate for the caller.",
    human:
